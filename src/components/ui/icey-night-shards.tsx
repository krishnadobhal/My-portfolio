...
const UNIFORMS = {
  // Theme palette: ink (#141312) -> deep amber -> accent amber (#ffb020) -> paper (#f3f2f2)
  colors: [[0.0784,0.0745,0.0706],[0.4706,0.2745,0.0784],[1,0.6902,0.1255],[0.9529,0.9490,0.9490],[0.9529,0.9490,0.9490],[0.9529,0.9490,0.9490],[0.9529,0.9490,0.9490],[0.9529,0.9490,0.9490]] as [number, number, number][],
  colorCount: 4,
  scale: 1.500,
  intensity: 0.480,
  paramA: 0.500,
